...
@section('content')<div class="ds-page">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="{{ route('web.relief-distributions.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i>
        Add New</a>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="filter-grid-3">
          <div class="flex-grow-1">
            ...
            <input type="text" name="search" class="form-control" placeholder="Household ID or item name"
          ...
          <div class="actions d-flex gap-2" style="justify-self:end">
            ...
            <a href="{{ route('web.relief-distributions.index') }}" class="btn btn-filter-outline"><i
    ...
    <div class="card">
      <div class="card-body">
        @if(isset($distributions) && $distributions->count())
          ...
          <tr class="clickable-row" style="cursor: pointer;" data-href="{{ route('web.relief-distributions.show', $d->id) }}">
            ...
            <td onclick="event.stopPropagation()">
              <div class="btn-group btn-group-sm">
                <a href="{{ route('web.relief-distributions.edit', $d->id) }}" class="btn btn-outline-secondary" title="Edit">
                  <i class="bi bi-pencil-fill"></i>
                </a>
                <form action="{{ route('web.relief-distributions.destroy', $d->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Archive this distribution?')">
                  @csrf
                  @method('DELETE')
