    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <header style="position: fixed; top: 0; left: 0; right: 0; z-index: 1200; height: 64px; display: flex; align-items: center; justify-content: space-between; padding: 0 1.5rem; background: #ffffff; border-bottom: 1px solid #e5e7eb;">
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <!-- Logo & System Title -->
                <a href="{{ auth()->check() && auth()->user()->isCalamityHead() ? route('calamities.dashboard') : route('dashboard') }}" style="display: flex; align-items: center; gap: 0.5rem; text-decoration: none;">
                    <img src="{{ asset('logo.png') }}" alt="Logo" style="width: 36px; height: 36px; object-fit: contain;" onerror="this.style.display='none'">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow" style="min-width: 300px; border-radius: 12px;">
                            ...
                            @if($annCount > 0)
                                ...
                                <a class="dropdown-item text-center" href="{{ route('announcements.index') }}" style="color: var(--color-primary); font-weight: 500;">
        ...
        <div class="flex" style="padding-top: 64px;">
            ...
            <aside class="sidebar">
                ...
                @if(auth()->user()->isSecretary())
                    ...
                    <div class="collapse {{ request()->routeIs('residents.*', 'households.*', 'census.*', 'puroks.*', 'resident-transfers.*', 'certificates.*', 'approvals.*', 'archives.*') ? 'show' : '' }}" id="profilingSubmenu">
                        <nav class="nav flex-column ms-3">
                            ...
                            <a class="nav-link {{ request()->routeIs('resident-transfers.*') ? 'active' : '' }}" 
                               href="{{ route('resident-transfers.index') }}"
                    ...
                    <div class="collapse {{ request()->routeIs('calamities.*', 'web.calamity-*', 'web.evacuation-*', 'web.relief-*', 'web.damage-*', 'web.notifications.*', 'notifications.*', 'web.response-*', 'response-team-members.*', 'web.calamity-reports.*') ? 'show' : '' }}" id="calamitySubmenu">
                        <nav class="nav flex-column ms-3">
                            <a class="nav-link {{ (request()->routeIs('calamities.*') && !request()->routeIs('calamities.dashboard')) ? 'active' : '' }}"
                               href="{{ route('calamities.index') }}"
                            ...
                            <a class="nav-link {{ request()->routeIs('web.evacuation-centers.*') ? 'active' : '' }}"
                               href="{{ route('web.evacuation-centers.index') }}"
                            ...
                            <a class="nav-link {{ request()->routeIs('web.relief-items.*') ? 'active' : '' }}"
                               href="{{ route('web.relief-items.index') }}"
                            ...
                            <a class="nav-link {{ request()->routeIs('web.relief-distributions.*') ? 'active' : '' }}"
                               href="{{ route('web.relief-distributions.index') }}"
                            ...
                            <a class="nav-link {{ request()->routeIs('web.damage-assessments.*') ? 'active' : '' }}"
                               href="{{ route('web.damage-assessments.index') }}"
                            ...
                            <a class="nav-link {{ request()->routeIs('web.response-team-members.*') ? 'active' : '' }}"
                               href="{{ route('web.response-team-members.index') }}"
                ...
                @if(auth()->user()->isStaff())
                    ...
                    <a class="nav-link {{ request()->routeIs('staff.resident-transfers.*') ? 'active' : '' }}" 
                       href="{{ route('staff.resident-transfers.index') }}"
                       data-tooltip="Resident Transfers">
                        <i class="bi bi-arrow-left-right"></i>
                        <span class="nav-link-text">Resident Transfers</span>
                    </a>
