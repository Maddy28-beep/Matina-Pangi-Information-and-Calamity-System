...
<form action="<?php echo e(auth()->user()->isStaff() ? route('staff.households.store') : route('households.store')); ?>" method="POST" id="householdForm">
    <?php echo csrf_field(); ?>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="household_type" name="household_type" required>
                        ...
                        <option value="family" <?php echo e(old('household_type') == 'family' ? 'selected' : ''); ?>>Head of the Family</option>
                    ...
                    <select class="form-select" id="parent_household_id" name="parent_household_id" style="width: 100%;">
                        ...
                        <?php $__currentLoopData = $households; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $household): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($household->id); ?>" 
                                    data-address="<?php echo e($household->address); ?>"
                                    data-purok="<?php echo e($household->purok); ?>"
                                    data-housing-type="<?php echo e($household->housing_type); ?>"
                                    data-has-electricity="<?php echo e($household->has_electricity); ?>"
                                    data-electric-account="<?php echo e($household->electric_account_number); ?>"
                                    <?php echo e(old('parent_household_id') == $household->id ? 'selected' : ''); ?>>
                ...
                <div id="regular_household_fields">
                    <input type="hidden" id="purok" name="purok" value="<?php echo e(old('purok')); ?>">
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(auth()->user()->isStaff() ? route('staff.households.index') : route('households.index')); ?>" class="btn btn-secondary">
...
$(document).ready(function() {
    ...
    const dupCheckUrl = '<?php echo e(route('residents.check-duplicate')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matina_final\resources\views/households/create.blade.php ENDPATH**/ ?>