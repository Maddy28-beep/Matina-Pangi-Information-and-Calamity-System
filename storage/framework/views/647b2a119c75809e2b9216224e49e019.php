    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <header
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <!-- Logo & System Title -->
                <a href="<?php echo e(auth()->check() && auth()->user()->isCalamityHead() ? route('calamities.dashboard') : route('dashboard')); ?>"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end shadow" style="min-width: 300px; border-radius: 12px;">
                                ...
                                <?php if($annCount > 0): ?>
                                    ...
                                    <a class="dropdown-item text-center" href="<?php echo e(route('announcements.index')); ?>"
                    ...
                    <div class="dropdown">
                        <button class="btn d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown"
                            ...
                            <div class="d-none d-sm-block text-start" style="line-height: 1.1;">
                                <div style="font-size: 0.8rem; font-weight: 600; color: #374151;"><?php echo e(auth()->user()->name); ?>
            ...
            <aside class="sidebar">
                <nav class="nav flex-column">
                    ...
                    <?php if(auth()->user()->isSecretary()): ?>
                        ...
                        <div class="collapse <?php echo e(request()->routeIs('residents.*', 'staff.residents.*', 'households.*', 'staff.households.*', 'census.*', 'puroks.*', 'resident-transfers.*', 'staff.resident-transfers.*', 'certificates.*', 'approvals.*', 'archives.*') ? 'show' : ''); ?>"
                            id="profilingSubmenu">
                            <nav class="nav flex-column ms-3">
                                <a class="nav-link <?php echo e(request()->routeIs('residents.*', 'staff.residents.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(auth()->user()->isSecretary() ? route('residents.index') : route('staff.residents.index')); ?>"
                                    data-tooltip="Residents">
                                    <i class="bi bi-people"></i>
                                    <span class="nav-link-text">Residents</span>
                                </a>
                                <a class="nav-link <?php echo e(request()->routeIs('households.*', 'staff.households.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(auth()->user()->isSecretary() ? route('households.index') : route('staff.households.index')); ?>"
                                ...
                                <a class="nav-link <?php echo e(request()->routeIs('puroks.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('puroks.index')); ?>" data-tooltip="Puroks">
                                    <i class="bi bi-geo-alt"></i>
                                    <span class="nav-link-text">Puroks</span>
                                </a>
                                <a class="nav-link <?php echo e(request()->routeIs('census.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('census.index')); ?>" data-tooltip="Census">
                                    <i class="bi bi-bar-chart"></i>
                                    <span class="nav-link-text">Census</span>
                                </a>
                                <a class="nav-link <?php echo e(request()->routeIs('resident-transfers.*', 'staff.resident-transfers.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(auth()->user()->isSecretary() ? route('resident-transfers.index') : route('staff.resident-transfers.index')); ?>"
                                ...
                                <a class="nav-link <?php echo e(request()->routeIs('certificates.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('certificates.index')); ?>" data-tooltip="Certificates">
                                    <i class="bi bi-file-earmark-text"></i>
                                    <span class="nav-link-text">Certificates</span>
                                </a>
                                <a class="nav-link <?php echo e(request()->routeIs('approvals.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('approvals.index')); ?>" data-tooltip="Approvals">
                        ...
                        <?php if(config('app.calamity_secretary_enabled')): ?>
                            ...
                            <div class="collapse <?php echo e(request()->routeIs('calamities.*', 'web.calamity-*', 'web.evacuation-*', 'web.relief-*', 'web.damage-*', 'web.notifications.*', 'notifications.*', 'web.response-*', 'response-team-members.*', 'web.calamity-reports.*') ? 'show' : ''); ?>"
                                id="calamitySubmenu">
                                <nav class="nav flex-column ms-3">
                                    <a class="nav-link <?php echo e((request()->routeIs('calamities.*') && !request()->routeIs('calamities.dashboard')) ? 'active' : ''); ?>"
                                        href="<?php echo e(route('calamities.index')); ?>" data-tooltip="Calamity Incidents">
                                    ...
                                    <a class="nav-link <?php echo e(request()->routeIs('web.evacuation-centers.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.evacuation-centers.index')); ?>" data-tooltip="Evacuation Centers">
                                        <i class="bi bi-building"></i>
                                        <span class="nav-link-text">Evacuation Centers</span>
                                    </a>
                                    <a class="nav-link <?php echo e(request()->routeIs('web.relief-items.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.relief-items.index')); ?>" data-tooltip="Relief Goods">
                                    ...
                                    <a class="nav-link <?php echo e(request()->routeIs('web.relief-distributions.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.relief-distributions.index')); ?>" data-tooltip="Relief Distribution">
                                    ...
                                    <a class="nav-link <?php echo e(request()->routeIs('web.damage-assessments.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.damage-assessments.index')); ?>" data-tooltip="Damage Assessment">
                                    ...
                                    <a class="nav-link <?php echo e(request()->routeIs('web.calamity-reports.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.calamity-reports.index')); ?>" data-tooltip="Reports">
                                        <i class="bi bi-file-earmark-bar-graph"></i>
                                        <span class="nav-link-text">Reports</span>
                                    </a>
                                    <a class="nav-link <?php echo e(request()->routeIs('web.notifications.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.notifications.index')); ?>" data-tooltip="Emergency Notifications">
                                    ...
                                    <a class="nav-link <?php echo e(request()->routeIs('web.response-team-members.*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('web.response-team-members.index')); ?>" data-tooltip="Response Team">
                    ...
                    <?php elseif(auth()->user()->isCalamityHead()): ?>
                        ...
                        <a class="nav-link <?php echo e(request()->routeIs('web.calamity-affected-households.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('web.calamity-affected-households.index')); ?>" data-tooltip="Affected Households">
                            <i class="bi bi-people"></i>
                            <span class="nav-link-text">Affected Households</span>
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('web.evacuation-centers.*') ? 'active' : ''); ?>"
                    ...
                    <?php if(auth()->user()->isStaff()): ?>
                        <a class="nav-link <?php echo e(request()->routeIs('staff.residents.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('staff.residents.index')); ?>" data-tooltip="Residents">
                            <i class="bi bi-people"></i>
                            <span class="nav-link-text">Residents</span>
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('staff.households.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('staff.households.index')); ?>" data-tooltip="Households">
                            <i class="bi bi-house"></i>
                            <span class="nav-link-text">Households</span>
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('staff.census.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('staff.census.index')); ?>" data-tooltip="Census">
                            <i class="bi bi-bar-chart"></i>
                            <span class="nav-link-text">Census</span>
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('staff.puroks.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('staff.puroks.index')); ?>" data-tooltip="Puroks">
                            <i class="bi bi-geo-alt"></i>
                            <span class="nav-link-text">Puroks</span>
                        </a>
                        <a class="nav-link <?php echo e(request()->routeIs('staff.submissions.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('staff.submissions.index')); ?>" data-tooltip="My Submissions">
                            <i class="bi bi-file-earmark-text"></i>
                        ...
                        <a class="nav-link <?php echo e(request()->routeIs('staff.resident-transfers.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('staff.resident-transfers.index')); ?>" data-tooltip="Resident Transfers">
                            <i class="bi bi-arrow-left-right"></i>
                            <span class="nav-link-text">Resident Transfers</span>
                        </a>
                    ...
                    <?php if(auth()->user()->isSecretary()): ?>
                        ...
                        <a class="nav-link <?php echo e(request()->routeIs('announcements.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('announcements.index')); ?>" data-tooltip="Announcements">
                            <i class="bi bi-megaphone"></i>
                        ...
                        <a class="nav-link <?php echo e(request()->routeIs('archives.*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('archives.index')); ?>" data-tooltip="Archives">
