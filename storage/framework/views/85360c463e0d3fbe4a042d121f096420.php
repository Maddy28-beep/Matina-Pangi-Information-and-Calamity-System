...
<div class="dashboard-content-wrapper" style="background: #f6f8f7; min-height: 100vh;">
    ...
    <?php $pendingApprovals = (\App\Models\Resident::pending()->count()) + (\App\Models\Household::pending()->count()); ?>
    <?php if($pendingApprovals > 0): ?>
    <div class="alert alert-warning d-flex justify-content-between align-items-center">
      <div><i class="bi bi-clock-history"></i> Pending approvals: <strong><?php echo e($pendingApprovals); ?></strong></div>
      <a href="<?php echo e(route('approvals.index')); ?>" class="btn btn-sm btn-warning"><i class="bi bi-arrow-right"></i> Open Approvals</a>
    </div>
    <?php endif; ?>
    <?php endif; ?>
    ...
    <div class="stats-grid">
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(route('residents.index')); ?>?age_min=13&age_max=19'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_teens'])); ?></h3>
                    <p class="text-muted mb-0">Teens (13–19)</p>
                </div>
            </div>
        </div>
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(route('residents.index')); ?>?voter_status=1'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_voters'])); ?></h3>
                    <p class="text-muted mb-0">Registered Voters</p>
                </div>
            </div>
        </div>
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(route('residents.index')); ?>?is_4ps=1'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_4ps'])); ?></h3>
                    <p class="text-muted mb-0">4Ps Beneficiaries</p>
                </div>
            </div>
        </div>
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(auth()->user()->isStaff() ? route('staff.households.index') : route('households.index')); ?>'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['average_household_size'], 1)); ?></h3>
    ...
    <div class="stats-grid">
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(route('residents.index')); ?>'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_residents'])); ?></h3>
        ...
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(auth()->user()->isStaff() ? route('staff.households.index') : route('households.index')); ?>'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_households'])); ?></h3>
                    <p class="text-muted mb-0">Households</p>
                </div>
            </div>
        </div>
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(route('residents.index')); ?>?age_min=60'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_senior_citizens'])); ?></h3>
                    <p class="text-muted mb-0">Senior Citizens</p>
                </div>
            </div>
        </div>
        <div>
            <div class="card stat-card h-100" onclick="window.location.href='<?php echo e(route('residents.index')); ?>?is_pwd=1'">
                <div class="card-body">
                    <h3 class="fw-bold mb-1"><?php echo e(number_format($stats['total_pwd'])); ?></h3>
    ...
    <div class="card border-0 shadow-sm mb-5">
        ...
        <div class="card-body">
            <div class="quick-actions-grid">
                <?php if(auth()->user()->isSecretary()): ?>
                    <a class="btn btn-outline-primary w-100" href="<?php echo e(route('households.create')); ?>">Register Household</a>
                    <a class="btn btn-outline-primary w-100" href="<?php echo e(route('households.index')); ?>">Add Resident</a>
                    <a class="btn btn-outline-primary w-100" href="<?php echo e(route('certificates.create')); ?>">Issue Certificate</a>
                ...
                <?php else: ?>
                    <?php if(auth()->user()->isStaff()): ?>
                        <a class="btn btn-outline-primary w-100" href="<?php echo e(route('staff.households.create')); ?>">Register Household</a>
                        <a class="btn btn-outline-primary w-100" href="<?php echo e(route('staff.residents.index')); ?>">Add Resident</a>
                        <a class="btn btn-outline-primary w-100" href="<?php echo e(route('certificates.create')); ?>">Issue Certificate</a>
                        <a class="btn btn-outline-primary w-100" href="<?php echo e(route('census.index')); ?>">View Census</a>
                        <a class="btn btn-outline-primary w-100" href="<?php echo e(route('staff.submissions.index')); ?>">My Submissions</a>
                    <?php else: ?>
                        <a class="btn btn-outline-primary w-100" href="<?php echo e(route('census.index')); ?>">View Census</a>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a class="btn btn-sm btn-outline-light text-white" href="<?php echo e(route('census.index')); ?>">View Census</a>
                    <a class="btn btn-sm btn-outline-light text-white" href="<?php echo e(route('residents.index')); ?>">View All</a>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $recentResidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="clickable-row" data-href="<?php echo e(auth()->user()->isStaff() ? route('staff.residents.show', $resident) : route('residents.show', $resident)); ?>">
                                    <td><span class="badge bg-light text-dark"><?php echo e($resident->resident_id); ?></span></td>
                                    <td class="fw-semibold"><?php echo e($resident->full_name); ?></td>
                                    ...
                                    <td>
                                        <?php if($resident->household): ?>
                                            <span class="text-decoration-none"><i class="bi bi-house-fill text-success"></i> <?php echo e($resident->household->household_id); ?></span>
                                        <?php else: ?>
                                            <span class="text-muted">No household</span>
                                        <?php endif; ?>
                                    </td>
                                    <td><small class="text-muted"><i class="bi bi-clock"></i> <?php echo e($resident->created_at->diffForHumans()); ?></small></td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matina_final\resources\views/dashboard.blade.php ENDPATH**/ ?>