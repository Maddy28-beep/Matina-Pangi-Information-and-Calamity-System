        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content text-center text-lg-start">
                    ...
                    <h2 class="hero-subtitle">Information and Calamity System</h2>
                    <p class="hero-tagline"><i class="bi bi-star-fill text-warning"></i> Resident Management Subsystem
                    </p>
                ...
                <div class="col-lg-6 hero-image text-center mt-5 mt-lg-0">
                    <img src="<?php echo e(asset('pangi.jpg')); ?>" alt="Barangay Matina Pangi"
                        style="max-width: 500px; width: 100%;" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-4">
                    <div class="card feature-card">
                        ...
                        <p class="feature-text">
                            Efficiently manage resident records with comprehensive profiles including personal
                            information,
            ...
            <div class="row">
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number">
                            <?php echo e(\App\Models\Resident::where('approval_status', 'approved')->count()); ?>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number">
                            <?php echo e(\App\Models\Household::where('approval_status', 'approved')->count()); ?>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number">
                            <?php echo e(\App\Models\Resident::where('approval_status', 'approved')->where('is_senior_citizen', true)->count()); ?>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number">
                            <?php echo e(\App\Models\Resident::where('approval_status', 'approved')->where('is_voter', true)->count()); ?>
                ...
                <div class="col-md-4">
                    <div class="card news-card">
                        <div class="card-body">
                            ...
                            <p class="news-date mt-2"><i class="bi bi-calendar3 me-2"></i><?php echo e(now()->format('F d, Y')); ?>

                            </p>
                            <h3 class="news-title">System Launch</h3>
                            <p class="text-muted">
                                The Barangay Matina Pangi Information and Calamity System is now live!
...
</html><?php /**PATH C:\xampp\htdocs\matina_final\resources\views/welcome-enhanced.blade.php ENDPATH**/ ?>