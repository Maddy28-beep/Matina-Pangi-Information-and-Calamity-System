...
<?php $__env->startSection('content'); ?><div class="ds-page">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(auth()->user()->isStaff() ? route('staff.households.index') : route('households.index')); ?>">Households</a></li>
...
<div class="d-flex justify-content-between align-items-end mb-2">
    ...
    <div class="btn-group action-buttons" style="max-width: 100%;">
        ...
        <?php endif; ?>
        <a href="<?php echo e(auth()->user()->isStaff() ? route('staff.households.index') : route('households.index')); ?>" class="btn btn-secondary btn-back">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <?php if($household->purok): ?>
                    <p class="mb-0 text-muted"><?php echo e(optional($household->purok)->purok_name ?? $household->purok); ?></p>
                <?php endif; ?>
            ...
            <div class="col-md-3">
                ...
                ?>
                <?php if($primaryFam && $primaryFam->subHead): ?>
                    <p class="mb-1">
                        <span class="text-success fw-bold">⭐ <?php echo e($primaryFam->subHead->full_name); ?></span>
                        <br><small class="text-muted">Primary Head</small>
                    </p>
                <?php endif; ?>
                <?php if($coHeadFams->count() > 0): ?>
                    <?php $__currentLoopData = $coHeadFams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coFam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($coFam->subHead): ?>
                            <p class="mb-1">
                                <span class="text-primary fw-bold">👤 <?php echo e($coFam->subHead->full_name); ?></span>
                ...
                <div class="row text-center g-3">
                    <div class="col-md-2">
                        <div class="p-3 rounded" style="background-color: #f9fafb; border-left: 4px solid #4A6F52;">
                            <h3 class="mb-0" style="color: #374151;"><?php echo e($statistics['total_residents']); ?></h3>
                            <small class="text-muted">Total Residents</small>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="p-3 rounded" style="background-color: #f9fafb; border-left: 4px solid #4A6F52;">
                            <h3 class="mb-0" style="color: #374151;"><?php echo e($statistics['seniors']); ?></h3>
                            <small class="text-muted">Senior Citizens</small>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="p-3 rounded" style="background-color: #f9fafb; border-left: 4px solid #4A6F52;">
                            <h3 class="mb-0" style="color: #374151;"><?php echo e($statistics['teens']); ?></h3>
                            <small class="text-muted">Teens (13-19)</small>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="p-3 rounded" style="background-color: #f9fafb; border-left: 4px solid #4A6F52;">
                            <h3 class="mb-0" style="color: #374151;"><?php echo e($statistics['pwd']); ?></h3>
                            <small class="text-muted">PWD</small>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="p-3 rounded" style="background-color: #f9fafb; border-left: 4px solid #4A6F52;">
                            <h3 class="mb-0" style="color: #374151;"><?php echo e($statistics['voters']); ?></h3>
                            <small class="text-muted">Voters</small>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="p-3 rounded" style="background-color: #f9fafb; border-left: 4px solid #4A6F52;">
                            <h3 class="mb-0" style="color: #374151;"><?php echo e($statistics['four_ps']); ?></h3>
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="mb-0">
                    ...
                    PRIMARY FAMILY
                    <?php if($household->officialHead): ?>
                        <small style="color: #1f2937; font-weight: 600; opacity: 0.8;">(<?php echo e($household->officialHead->full_name); ?>)</small>
                    <?php endif; ?>
                </h4>
            </div>
            <div class="col-md-4 text-end">
                <span class="badge" style="background: white; color: #1f2937; border: 2px solid #1f2937; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($primaryStats['total']); ?> Members</span>
                <?php if($primaryStats['seniors'] > 0): ?>
                    <span class="badge" style="background: white; color: #0ea5e9; border: 2px solid #0ea5e9; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($primaryStats['seniors']); ?> Seniors</span>
                <?php endif; ?>
                <?php if($primaryStats['pwd'] > 0): ?>
                    <span class="badge" style="background: white; color: #dc2626; border: 2px solid #dc2626; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($primaryStats['pwd']); ?> PWD</span>
                <?php endif; ?>
                <?php if($primaryStats['four_ps'] > 0): ?>
                    <span class="badge" style="background: white; color: #4A6F52; border: 2px solid #4A6F52; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($primaryStats['four_ps']); ?> 4Ps</span>
                <?php endif; ?>
            </div>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="table-row-clickable <?php echo e($member->status !== 'active' ? 'table-secondary' : ''); ?>" 
                        onclick="window.location='<?php echo e(route('residents.show', $member)); ?>'" 
        ...
        <div class="card-header bg-primary bg-opacity-10">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="mb-0">
                        ...
                        <?php if($extendedFamily->subHead): ?>
                            <small style="color: #1f2937; font-weight: 600; opacity: 0.8;">(<?php echo e($extendedFamily->sub_family_name); ?>)</small>
                            <div class="mt-2">
                ...
                <div class="col-md-4 text-end">
                    ...
                    ?>
                    <span class="badge" style="background: white; color: #1f2937; border: 2px solid #1f2937; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($familyStats['total']); ?> Members</span>
                    <?php if($familyStats['seniors'] > 0): ?>
                        <span class="badge" style="background: white; color: #0ea5e9; border: 2px solid #0ea5e9; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($familyStats['seniors']); ?> Seniors</span>
                    <?php endif; ?>
                    <?php if($familyStats['pwd'] > 0): ?>
                        <span class="badge" style="background: white; color: #dc2626; border: 2px solid #dc2626; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($familyStats['pwd']); ?> PWD</span>
                    <?php endif; ?>
                    <?php if($familyStats['four_ps'] > 0): ?>
                        <span class="badge" style="background: white; color: #4A6F52; border: 2px solid #4A6F52; font-size: 1rem; padding: 0.5rem 1rem; font-weight: 700;"><?php echo e($familyStats['four_ps']); ?> 4Ps</span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <form action="<?php echo e(route('households.store-member', $household)); ?>" method="POST">
                ...
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="addMemberModalLabel">
                        <i class="bi bi-person-plus"></i> Add Member to Household <?php echo e($household->household_id); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="sub_family_id" class="form-select form-select-lg" required>
                            ...
                            <?php if($primaryFamily && $primaryFamily->subHead): ?>
                                <option value="<?php echo e($primaryFamily->id); ?>" class="fw-bold">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matina_final\resources\views/households/show.blade.php ENDPATH**/ ?>